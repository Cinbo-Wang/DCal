...
## Examples
We use the following examples to illustrate the basic usage of the DCal package. Here, the PS model is sparse linear model, while the OR model is dense nonlinear.
